...
#line 150 "parser.y"
        {addtotable((char)(yyvsp[-3].id),(char)(yyvsp[-1].ch), '='); printf("Recognized interval declaration with assignment and calculation: %c \n", (yyvsp[-3].id)); }
...
#line 1259 "parser.tab.c"
  ...
  case 19: /* arithmetic_expr: T_IDENTIFIER T_PLUS T_IDENTIFIER  */
#line 168 "parser.y"
                                     {(yyval.ch) = addtotable((char)(yyvsp[-2].id), (char)(yyvsp[0].id), '+'); }
#line 1265 "parser.tab.c"
    break;

  case 20: /* arithmetic_expr: T_IDENTIFIER T_MINUS T_IDENTIFIER  */
#line 169 "parser.y"
                                         {(yyval.ch) = addtotable((char)(yyvsp[-2].id), (char)(yyvsp[0].id), '-'); }
#line 1271 "parser.tab.c"
    break;

  case 21: /* arithmetic_expr: T_IDENTIFIER T_MULT T_IDENTIFIER  */
#line 170 "parser.y"
                                        {(yyval.ch) = addtotable((char)(yyvsp[-2].id), (char)(yyvsp[0].id), '*'); }
#line 1277 "parser.tab.c"
    break;

  case 22: /* arithmetic_expr: T_IDENTIFIER T_DIVIDE T_IDENTIFIER  */
#line 171 "parser.y"
                                          {(yyval.ch) = addtotable((char)(yyvsp[-2].id), (char)(yyvsp[0].id), '/'); }
